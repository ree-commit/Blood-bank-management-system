    ...
    <div id="body">
        <form id='frm1' name='frm1' method='post' action="">
            <center> <table id="login">
               ...
               <tr><td>Email :</td>
                   <td>  <input type="email" id="w" name="email" /></td></tr>
              </table></br>
               <input type="submit" id="sub" name="sub" value="Recover Password" />
        </form>
        <%
            String result="";
           String pwd="";
            ...
            {
            String qry="select * from admin_login where user='"+request.getParameter("user")+"' and email='"+request.getParameter("email")+"'";
            result=cc.checkdata(qry);
            if(result.equals("success"))
            {
            String qry1="select password from admin_login where user='"+request.getParameter("user")+"' and email='"+request.getParameter("email")+"'";
             pwd=cc.getsinglerecord(qry1);
            result="<h2>your password is : '"+pwd+"'</h2>";
